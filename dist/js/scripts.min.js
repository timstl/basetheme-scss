...
"use strict";!function(r){r.fn.scrollclass=function(s){var l=r.extend({},r.fn.scrollclass.defaults,s),c=this,o=!1;r(document).scroll(function(){0==o&&r(this).scrollTop()>l.pos?(o=!0,c.addClass(l.class)):r(this).scrollTop()<l.pos&&(o=!1,c.removeClass(l.class))}).trigger("scroll")},r.fn.scrollclass.defaults={class:"scrolled",pos:50}}(jQuery),jQuery(document).ready(function(s){var l=s("#header");0<l.length&&l.scrollclass({pos:l.outerHeight()})});