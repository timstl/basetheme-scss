...
"use strict";!function(e){e.fn.scrollclass=function(s){var l=e.extend({},e.fn.scrollclass.defaults,s),c=this,o=!1;e(document).scroll(function(){0==o&&e(this).scrollTop()>l.pos?(o=!0,c.addClass(l.class)):e(this).scrollTop()<l.pos&&(o=!1,c.removeClass(l.class))}).trigger("scroll")},e.fn.scrollclass.defaults={class:"scrolled",pos:50}}(jQuery),jQuery(document).ready(function(s){var l=s("#site-header");0<l.length&&l.scrollclass({pos:l.outerHeight()})});