...
!function(t,n,i,e){"function"==typeof define&&define.amd?define(function(){return e(t,n,i)}):"object"==typeof exports?module.exports=e:t.ssm=e(t,n,i)}(window,document,void 0,function(t,n,i){"use strict";function e(t){this.message=t,this.name="Error"}function o(t){this.id=t.id||h(),this.query=t.query||"all",delete t.id,delete t.query;var n={onEnter:[],onLeave:[],onResize:[],onFirstRun:[]};return this.options=a(n,t),"function"==typeof this.options.onEnter&&(this.options.onEnter=[this.options.onEnter]),"function"==typeof this.options.onLeave&&(this.options.onLeave=[this.options.onLeave]),"function"==typeof this.options.onResize&&(this.options.onResize=[this.options.onResize]),"function"==typeof this.options.onFirstRun&&(this.options.onFirstRun=[this.options.onFirstRun]),!1===this.testConfigOptions("once")?(this.valid=!1,!1):(this.valid=!0,this.active=!1,void this.init())}function s(n){this.states=[],this.resizeTimer=null,this.configOptions=[],t.addEventListener("resize",u(this.resizeBrowser.bind(this),c),!0)}function r(t,n,i){for(var e=t.length,o=[],s=0;s<e;s++){var r=t[s];r[n]&&r[n]===i&&o.push(r)}return o}function a(t,n){var i={};for(var e in t)i[e]=t[e];for(var o in n)i[o]=n[o];return i}function h(){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=0;i<10;i++)t+=n.charAt(Math.floor(Math.random()*n.length));return t}function f(t){for(var n=t.length,i=0;i<n;i++)t[i]()}function u(t,n,i){var e;return function(){var o=this,s=arguments,r=function(){e=null,i||t.apply(o,s)},a=i&&!e;clearTimeout(e),e=setTimeout(r,n),a&&t.apply(o,s)}}var c=25,p=function(){};return o.prototype={init:function(){this.test=t.matchMedia(this.query),this.test.matches&&this.testConfigOptions("match")&&this.enterState(),this.listener=function(t){var n=!1;t.matches?this.testConfigOptions("match")&&(this.enterState(),n=!0):(this.leaveState(),n=!0),n&&p()}.bind(this),this.test.addListener(this.listener)},enterState:function(){f(this.options.onFirstRun),f(this.options.onEnter),this.options.onFirstRun=[],this.active=!0},leaveState:function(){f(this.options.onLeave),this.active=!1},resizeState:function(){this.testConfigOptions("resize")&&f(this.options.onResize)},destroy:function(){this.test.removeListener(this.listener)},attachCallback:function(t,n,i){switch(t){case"enter":this.options.onEnter.push(n);break;case"leave":this.options.onLeave.push(n);break;case"resize":this.options.onResize.push(n)}"enter"===t&&i&&this.active&&n()},testConfigOptions:function(t){for(var n=this.configOptions.length,i=0;i<n;i++){var e=this.configOptions[i];if(void 0!==this.options[e.name]&&e.when===t&&!1===e.test.bind(this)())return!1}return!0},configOptions:[]},s.prototype={addState:function(t){var n=new o(t);return n.valid&&this.states.push(n),n},addStates:function(t){for(var n=t.length-1;n>=0;n--)this.addState(t[n]);return this},getState:function(t){for(var n=this.states.length-1;n>=0;n--){var i=this.states[n];if(i.id===t)return i}},isActive:function(t){return(this.getState(t)||{}).active||!1},getStates:function(t){var n=null,i=[];if(void 0===t)return this.states;n=t.length;for(var e=0;e<n;e++)i.push(this.getState(t[e]));return i},removeState:function(t){for(var n=this.states.length-1;n>=0;n--){var i=this.states[n];i.id===t&&(i.destroy(),this.states.splice(n,1))}return this},removeStates:function(t){for(var n=t.length-1;n>=0;n--)this.removeState(t[n]);return this},removeAllStates:function(){for(var t=this.states.length-1;t>=0;t--){this.states[t].destroy()}this.states=[]},addConfigOption:function(t){t=a({name:"",test:null,when:"resize"},t),""!==t.name&&null!==t.test&&o.prototype.configOptions.push(t)},removeConfigOption:function(t){for(var n=o.prototype.configOptions,i=n.length-1;i>=0;i--)n[i].name===t&&n.splice(i,1);o.prototype.configOptions=n},getConfigOption:function(t){var n=o.prototype.configOptions;if("string"!=typeof t)return n;for(var i=n.length-1;i>=0;i--)if(n[i].name===t)return n[i]},getConfigOptions:function(){return o.prototype.configOptions},resizeBrowser:function(){for(var t=r(this.states,"active",!0),n=t.length,i=0;i<n;i++)t[i].resizeState()},stateChange:function(t){if("function"!=typeof t)throw new e("Not a function");p=t}},new s});
