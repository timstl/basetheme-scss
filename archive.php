...
?>
					<h1 class="pagetitle"><?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: <em>%s</em>', 'boilerplate' ), get_the_date() );
						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: <em>%s</em>', 'boilerplate' ), get_the_date('F Y') );
						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: <em>%s</em>', 'boilerplate' ), get_the_date('Y') );
						else :
